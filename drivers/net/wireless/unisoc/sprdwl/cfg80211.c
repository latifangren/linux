...
static int sprdwl_cfg80211_set_wiphy_params_v2(struct wiphy *wiphy,
					       int radio_idx, u32 changed)
{
	(void)radio_idx;
	return sprdwl_cfg80211_set_wiphy_params(wiphy, changed);
}
...
#endif /* IBSS_SUPPORT */
	.set_wiphy_params = sprdwl_cfg80211_set_wiphy_params_v2,
