...
#define compare_ether_addr(a, b) (!ether_addr_equal((const u8 *)(a), (const u8 *)(b)))
#endif
...
#else
static inline u32 rda_wlan_version(void)
{
	return WLAND_VER_91;
}

static inline u8 check_test_mode(void)
{
	return 0;
}

static inline u8 check_role_mode(void)
{
	return 0;
}

static inline int rda_wifi_power_on(void)
{
	return 0;
}

static inline int rda_wifi_power_off(void)
{
	return 0;
}
#endif
