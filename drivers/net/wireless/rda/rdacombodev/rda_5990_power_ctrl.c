...
static int rda_5990_wifi_rf_init(void)
{
	int ret = 0;
...
static int rda_5990_wifi_dc_cal(void)
{
	int ret = 0;
...
static int rda_5990_wifi_en(void)
{
	int ret = 0;
...
static int rda_5990_tm_wifi_en(void)
{
	int ret = 0;
	enable_26m_regulator(CLOCK_WLAN);
	enable_32k_rtc(CLOCK_WLAN);
...
static int rda_5990_tm_wifi_rf_init(void)
{
	int ret = 0;
	rda_combo_i2c_lock();
	if(rda_wlan_version() == WLAN_VERSION_90_D ||
...
static int rda_5990_wifi_dig_reset(void)
{
	int ret = 0;
