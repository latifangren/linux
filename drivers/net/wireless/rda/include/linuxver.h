...
/*
 * Kernel timer API compatibility for legacy driver sources.
 * Newer kernels renamed these helpers to timer_* variants.
 */
#ifndef from_timer
...
#ifndef strlcpy
static inline size_t strlcpy(char *dest, const char *src, size_t count)
{
	ssize_t ret;
...
#if __has_include(<net/lib80211.h>)
...
#define SMP_RD_BARRIER_DEPENDS() smp_rmb()
